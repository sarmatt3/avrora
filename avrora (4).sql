...
--
-- Хост: 127.0.0.1
-- Время создания: Май 31 2026 г., 21:16
...
INSERT INTO `admins` (`id`, `fullname`, `login`, `privilege`, `password`, `session_token`) VALUES
(1, 'Тогузов Сармат Гириханович', '01ADM-SARMATTOGUZOV', 16, '$2y$10$yD3Iu0aF/xxt23PhvHpMruaPHeCNa4C153HJS7jjauNF6aNjhc3X2', '?PIz?dX???]˽B??{?~??x???A?bꧪ=m????1w΁?X???ZL?^?,m?????'),
(2, 'Admin', '01ADM-ADMIN', 15, '$2y$10$GfHDRY6lHNZOVAJsAV3XAOnuXVm5R2Lc3FedGPtXw.XQfZKaFyzny', '??z?\"?4(?-c?/?N	??E?E?ą??[~\r=Z?]T6P??(??~???q??.y~î?O?');
...
INSERT INTO `appeals` (`id`, `recipient`, `fullname`, `email`, `text`, `date`) VALUES
(10, 1, 'Sarmat', 'st@mail.ru', 'Это просто кошмар!!!', '2026-05-18'),
(11, 1221815181, 'Тогузов', 'sarmat.toguzov@inbox.ru', 'gfjasfghjdgfhjgsdh hhsd gjhdg sjgd gjhdsg jhhasgd jdgs hagdjhsag jdshg jdgfs jhagdsfjhg djhsg hjg djhsdg ajh gdsjhg jhdg jhgjhdsg jdsh gjdsg jf gdsjhg jhsdg jhgafds jg fjhdsghjg djsga jhgdsjhgadsjgf jhdsag jhg adjsg fjgdsja fgjhsdagf jgd jga jhfag jgjdgsjfgdjhfg jhgd jgfdjhg dsjg jfahsdgfj gdjshafgjdhsag fjdsgajh g ajgjha gjfdgf jhf jg jg fdjagdjg djsag jfdg ghjdfsg jgdfsjg fjfdsag jfgdsaj gfdsfj hdsj gjkdasgfdg jfg dgskaj gfdg fgdh gjhdsgfg dgsfagjdasgjhfg jhdgdjfsgjg gdsjg fdsjgfdsjgfjdsjhgfj', '2026-05-27');
...
(76, 2, 'Vincenzo', '22 июля', '18:00', 4, 'Генерала Плиева д. 17'),
(78, 1, 'ТОРНЕ', '20 июля', '19:00', 1, 'Гизельское шоссе д.26'),
(80, 1, 'ТОРНЕ', '19 июля', '17:00', 1, 'Гизельское шоссе д.26'),
(81, 1, 'ТОРНЕ', '18 июля', '18:00', 4, 'Гизельское шоссе д.26'),
(82, 1, 'ТОРНЕ', '19 июля', '18:00', 1, 'Гизельское шоссе д.26');
...
ALTER TABLE `admins`
  ...
  ADD UNIQUE KEY `token` (`session_token`);
